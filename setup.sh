...
INCLUDE_COUNT="$(git config --global --get-all include.path 2>/dev/null | grep -Fxc "$REPO_ROOT/gitconfig.shared" || true)"
...
manifest_add_entry "git_include_path" "$REPO_ROOT/gitconfig.shared"
